...
# Page settings
st.set_page_config(page_title=" Airline Demand Tracker", layout="centered")
st.title(" Airline Market Demand Web App")
...
try:
    ...
    if "data" in data and data["data"]:
        ...
        if routes:
            ...
            st.warning(" No routes found in the current API response.")
    else:
